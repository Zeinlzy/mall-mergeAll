...
public class PmsBrandController {
    ...
    @Operation(summary = "获取全部品牌列表")  //测试通过
    ...
    @Operation(summary = "根据品牌名称分页获取品牌列表")  //测试通过
    ...
    @Operation(summary = "根据编号查询品牌信息")  //测试通过
    ...
    @Operation(summary = "批量更新显示状态")  //测试通过
    ...
    @Operation(summary = "批量更新厂家制造商状态") //测试通过
