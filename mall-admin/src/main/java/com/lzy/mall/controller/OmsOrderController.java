...
public class OmsOrderController {
    ...
    @Operation(summary = "获取订单详情：订单信息、商品信息、操作记录")  //测试通过
    ...
    @Operation(summary = "修改收货人信息")  //测试通过
    ...
    @Operation(summary = "修改订单费用信息") //测试通过
